...
print("<body>");
    ...
    $css->CrearTabla();
        ...
        $css->FilaTabla(16);
            ...
            print("</td>");
            print("<td>");
                $css->CrearBotonEvento("BtnAgregar", "Agregar", 1, "OnClick", "AgregaInsumo()", "naranja", "");
            print("</td>");
        $css->CierraFilaTabla();
        ...
        $css->FilaTabla(16);
            ...
            print("</td>");
            print("<td>");
                $css->CrearBotonEvento("BtnAgregar", "Agregar", 1, "OnClick", "AgregaServicio()", "naranja", "");
            print("</td>");
        $css->CierraFilaTabla();
        ...
        $css->FilaTabla(16);
            ...
            print("</td>");
            print("<td>");
                $css->CrearBotonEvento("BtnAgregar", "Agregar", 1, "OnClick", "AgregaProducto()", "naranja", "");
            print("</td>");
        $css->CierraFilaTabla();
    $css->CerrarTabla();
    $css->CerrarDiv();    
